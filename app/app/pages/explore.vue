...
<template>
    <div class="space-y-6">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="card">
                <h3 class="mb-3 font-medium">PM2.5 Time Series</h3>
                <ChartPanel :option="lineOption" />
            </div>
            <div class="card">
                <h3 class="mb-3 font-medium">Latest District Comparison</h3>
                <ChartPanel :option="barOption" />
            </div>
        </div>

        <div class="card">
            <h3 class="mb-1 font-medium">Mobility Proxy vs PM2.5</h3>
